...
Assert-FileContains (Join-Path $repoRoot 'src\CodexConversationMigrator.xaml') $windowVersionText 'Window version label'
...
$builtExe = Join-Path $repoRoot 'src\bin\Release\net48\CodexConversationMigrator.exe'
