...
internal static class UiLanguage
{
	...
	{
		{ "Codex 对话与项目管理", "Codex Conversation and Project Manager" },
		{ "对话与项目管理", "Conversation and Project Manager" },
		...
		{ "运行组件…", "Runtime component…" },
		{ "选择或重新定位 cct.exe；通常无需修改", "Choose or relocate cct.exe; usually no change is needed" },
		{ "刷新", "Refresh" },
