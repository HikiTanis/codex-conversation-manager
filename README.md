...
[简体中文](README.zh-CN.md) · Current release: v1.0.2
...
1. Download `CodexConversationManager-Windows-v1.0.2.zip` and `SHA256SUMS.txt` from GitHub Releases.
...
The source repository also contains `docs/releases/v1.0.2.md` (release notes), `CHANGELOG.md` (version history), `docs/RELEASING.md` (maintainer workflow), `.github/SUPPORT.md` (issue reporting), and `.github/CONTRIBUTING.md` (contributor guide).
