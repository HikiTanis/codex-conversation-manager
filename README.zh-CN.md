...
4. 删除或恢复前完全退出 Codex；如果旧版本已经留下点开报错的侧边栏条目，退出 Codex 后点击“刷新”，核对提示中的标题并确认清理。
